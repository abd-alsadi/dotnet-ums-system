...
{
    public class clsDepartmentPositionAttachment : KmnlkUMSModel
    {
        public string fldUid { set; get; }
        public string fldDepartmentPositionUid { set; get; }
        ...
        public clsDepartmentPosition fldDepartmentPosition { set; get; }
