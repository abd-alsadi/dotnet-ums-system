...
{
    public class RoleManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private RoleManager manager;
        private ILog logger;
        public RoleManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new RoleManager(conn, logger);  
        }
