...
{
    public class UserContactManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private UserContactManager manager;
        private ILog logger;
        public UserContactManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new UserContactManager(conn, logger);  
        }
