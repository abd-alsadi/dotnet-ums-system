...
{
    public class SettingManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private SettingsManager manager;
        private ILog logger;
        public SettingManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new SettingsManager(conn, logger);  
        }
