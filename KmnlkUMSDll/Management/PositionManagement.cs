...
{
    public class PositionManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private PositionManager manager;
        private ILog logger;
        public PositionManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new PositionManager(conn, logger);  
        }
