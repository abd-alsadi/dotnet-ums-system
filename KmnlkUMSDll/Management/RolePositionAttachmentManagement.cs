...
{
    public class RolePositionAttachmentManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private RolePositionAttachmentManager manager;
        private ILog logger;
        public RolePositionAttachmentManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new RolePositionAttachmentManager(conn, logger);  
        }
