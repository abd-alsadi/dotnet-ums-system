...
{
    public class RoleResponsipilityManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private RoleResponsipilityManager manager;
        private ILog logger;
        public RoleResponsipilityManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new RoleResponsipilityManager(conn, logger);  
        }
