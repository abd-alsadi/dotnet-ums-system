...
{
    public class UserManagment :ModelManagement, ICURDOperations, IValidationOperations
    {
        private UserManager manager;
        private ILog logger;
        public UserManagment(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new UserManager(conn, logger);  
        }
