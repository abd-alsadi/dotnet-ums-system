...
{
    public class DepartmentPositionNoteManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private DepartmentPositionNoteManager manager;
        private ILog logger;
        public DepartmentPositionNoteManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new DepartmentPositionNoteManager(conn, logger);  
        }
