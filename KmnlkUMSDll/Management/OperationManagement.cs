...
{
    public class OperationManagement : ModelManagement, ICURDOperations, IValidationOperations
    {
        private OperationManager manager;
        private ILog logger;
        public OperationManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new OperationManager(conn, logger);  
        }
