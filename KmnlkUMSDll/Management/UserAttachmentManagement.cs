...
{
    public class UserAttachmentManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private UserAttachmentManager manager;
        private ILog logger;
        public UserAttachmentManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new UserAttachmentManager(conn, logger);  
        }
