...
{
    public class ProfileManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private ProfileManager manager;
        private ILog logger;
        public ProfileManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new ProfileManager(conn, logger);  
        }
