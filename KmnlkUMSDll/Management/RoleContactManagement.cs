...
{
    public class RoleContactManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private RoleContactManager manager;
        private ILog logger;
        public RoleContactManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new RoleContactManager(conn, logger);  
        }
