...
{
    public class PositionContactManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private PositionContactManager manager;
        private ILog logger;
        public PositionContactManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new PositionContactManager(conn, logger);  
        }
