...
{
    public class DepartmentResponsipilityManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private DepartmentResponsipilityManager manager;
        private ILog logger;
        public DepartmentResponsipilityManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new DepartmentResponsipilityManager(conn, logger);  
        }
