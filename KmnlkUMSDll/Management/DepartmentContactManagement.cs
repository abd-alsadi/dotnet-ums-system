...
{
    public class DepartmentContactManagement : ModelManagement, ICURDOperations, IValidationOperations
    {
        private DepartmentContactManager manager;
        private ILog logger;
        public DepartmentContactManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new DepartmentContactManager(conn, logger);  
        }
