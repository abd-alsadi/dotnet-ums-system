...
{
    public class UserPositionNoteManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private UserPositionNoteManager manager;
        private ILog logger;
        public UserPositionNoteManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new UserPositionNoteManager(conn, logger);  
        }
