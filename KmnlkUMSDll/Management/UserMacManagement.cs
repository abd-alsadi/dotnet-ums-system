...
{
    public class UserMacManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private UserMacManager manager;
        private ILog logger;
        public UserMacManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new UserMacManager(conn, logger);  
        }
