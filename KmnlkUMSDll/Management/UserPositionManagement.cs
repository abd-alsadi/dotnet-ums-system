...
{
    public class UserPositionManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private UserPositionManager manager;
        private ILog logger;
        public UserPositionManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new UserPositionManager(conn, logger);  
        }
