...
{
    public class RolePrivilageManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private RolePrivilageManager manager;
        private ILog logger;
        public RolePrivilageManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new RolePrivilageManager(conn, logger);  
        }
