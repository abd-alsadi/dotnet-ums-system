...
{
    public class UserNoteManagement :ModelManagement, ICURDOperations, IValidationOperations
    {
        private UserNoteManager manager;
        private ILog logger;
        public UserNoteManagement(ConnectionManager conn,ILog logger)
        {
            this.logger = logger;
            manager = new UserNoteManager(conn, logger);  
        }
